...
public class AlunoRepository {
	...
	// Gravar aluno no banco de dados
	...
	// Procurar um aluno por matrícula
	...
	public List<Aluno> listAlunos(String matricula, String nome, Integer rg, Integer telefone) {
		...
		// A query vai terminar com '1 = 1'. Forma simples utilizando a tabela verdade sem precisar tirar o AND da String.
		jpql.append("1 = 1");
